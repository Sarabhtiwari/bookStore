...
const Navbar = () => {
  ...
  return (
    ...
    <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 
      ${sticky?"sticky-navbar shadow-md bg-base-200 duration-300 transition-all  dark:bg-slate-800 dark:text-white ease-in-out":""}  dark:bg-slate-900 dark:text-white`}>
